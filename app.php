        ...
        <div class="row">
            ...
            <div class="col-md-4">
                ...
                <div class="card card-body">
                    <form action="save_task.php?user=<?php echo $id_user?>" method="POST">
                    ...
                    while($row = mysqli_fetch_array($result_tasks)) { ?> 
                        <tr>
                            ...
                            <td>
                                ...
                                <a href="delete_task.php?id=<?php echo $row['id_task'] ?>&user=<?php echo $id_user?>" class="btn btn-danger">
